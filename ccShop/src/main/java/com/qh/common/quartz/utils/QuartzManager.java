package com.qh.common.quartz.utils;
...
public class QuartzManager {
	...
	public void addJob(ScheduleJob job) {
		try {
			...
			jobDetail.getJobDataMap().put(Constant.task_params, job.getParams());
			// 把作业和触发器注册到任务调度中
	 ...
	 * @throws SchedulerException
	 */
	public void runAJobNow(ScheduleJob scheduleJob,Date choiceDate) throws SchedulerException {
		JobKey jobKey = JobKey.jobKey(scheduleJob.getJobName(), scheduleJob.getJobGroup());
		JobDetail jobDetail = scheduler.getJobDetail(jobKey);
		if(jobDetail != null && ParamUtil.isNotEmpty(choiceDate)){
			jobDetail.getJobDataMap().put(Constant.task_choiceDate, choiceDate);
		}
